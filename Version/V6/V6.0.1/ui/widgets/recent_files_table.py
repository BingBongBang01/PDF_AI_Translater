...
class RecentFilesTable(MaterialTableWidget):
    def __init__(self, parent=None):
        ...
        self.setHorizontalHeaderLabels(["File Name", "Date", "Pages", "Language", "Status"])
    ...
    def load_mock_data(self):
        mock_files = [
            ("comic_vol1.pdf", "2026-07-27", "200", "JP -> KR", "Completed"),
            ("document_v2.pdf", "2026-07-26", "15", "EN -> KR", "Processing..."),
            ("invoice_scanned.png", "2026-07-25", "1", "AUTO -> EN", "Failed")
        ]
