...
class SettingsPage(BasePage):
    def setup_ui(self):
        ...
        categories = [
            "General", "Appearance", "Translation", "OCR", "PDF", 
            "Export", "Performance", "Network", "Storage", "Updates", 
            "Advanced", "About"
        ]
    ...
    def _build_general(self):
        def builder(layout):
            g = MaterialGroupBox("General Options")
            f = QFormLayout(g)
    ...
    def _build_translation(self):
        def builder(layout):
            ...
            self.cb_t_mod = MaterialComboBox(); self.cb_t_mod.addItems(["gemini-2.5-pro", "gpt-4o", "claude-3-5"])
