...
@patch("pdf_engine.preprocess.context.build_client")
def test_context_detection_academic(mock_build_client, mock_call_llm, sample_segments):
...
@patch("pdf_engine.preprocess.context.call_llm")
@patch("pdf_engine.preprocess.context.build_client")
def test_context_detection_fallback(mock_build_client, mock_call_llm, sample_segments):
